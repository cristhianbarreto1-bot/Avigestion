...
export default function ManagerDashboard() {
  ...
  // Clock
  useEffect(() => {
    setTimeStr(new Date().toLocaleTimeString("es-AR",{hour:"2-digit",minute:"2-digit"}));
    const t = setInterval(() => {
      setTimeStr(new Date().toLocaleTimeString("es-AR",{hour:"2-digit",minute:"2-digit"}));
    }, 60000);
  ...
  return (
    <div style={{
      ...
      {/* Botón Flotante para Probar Supervisor */}
      <div style={{ position: 'fixed', bottom: 20, right: 20, zIndex: 999 }}>
        <button 
          ...
          style={{
            ...
            fontWeight: 800,
            cursor: 'pointer',
            boxShadow: `0 4px 15px ${C.green}44`,
            display: 'flex',
            alignItems: 'center',
            gap: 8,
            fontSize: 14
